...
export const AdminNewOrderEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>New Order {orderNumber} - ${total.toLocaleString()}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Section style={alertBox}>
              ...
              <Text style={alertText}>
                Please process this order in the admin dashboard and prepare items for shipment.
              </Text>
            </Section>
            ...
            <Section>
              ...
              <Text style={quickAction}>
                📧 <Link href={`mailto:${customerEmail}`} style={actionLink}>Email Customer</Link>
              </Text>
              <Text style={quickAction}>
                📦 <Link href={`${siteUrl}/admin/orders`} style={actionLink}>Mark as Processing</Link>
              </Text>
              <Text style={quickAction}>
                🚚 <Link href={`${siteUrl}/admin/orders`} style={actionLink}>Add Tracking Info</Link>
              </Text>
            </Section>
          </Section>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              Kollect-It Admin Notifications
            </Text>
            <Text style={footerText}>
