      ...
      <body>
        <div className="min-h-dvh flex items-center justify-center bg-cream">
          <div className="max-w-lg rounded border border-border-neutral bg-white p-6 text-center shadow-sm">
            ...
            <p className="mt-2 text-ink-secondary">An unexpected error occurred. Please try again.</p>
            ...
            {process.env.NODE_ENV === 'development' && error?.message && (
              <pre className="mt-4 overflow-auto rounded bg-cream p-3 text-left text-xs text-ink-secondary">{error.message}</pre>
            )}
          </div>
        </div>
      </body>
