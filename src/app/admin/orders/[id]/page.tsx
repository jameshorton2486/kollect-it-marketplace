                  ...
                  {order.items.map((item) => (
                    <div key={item.id} className="order-item-row">
                      <div className="order-item-info">
                        <Link href={`/product/${item.product.slug}`} className="order-item-title">
                          {item.title}
                        </Link>
              ...
              <div className="admin-order-section">
                ...
                {editMode ? (
                  ...
                  <div className="order-tracking-info">
                    ...
                    {!order.carrier && !order.trackingNumber && !order.shippingLabelUrl && (
                      <p className="tracking-empty">No tracking information available yet.</p>
                    )}
                  </div>
                )}
              </div>
              ...
              <div className="admin-order-section">
                ...
                <div className="customer-details">
                  <div className="customer-detail-row">
                    ...
                    <span className="customer-value">{order.customerName || 'Guest'}</span>
                  </div>
                  <div className="customer-detail-row">
                    <span className="customer-label">Email:</span>
                    <a href={`mailto:${order.customerEmail}`} className="customer-value customer-link">
                      {order.customerEmail}
                    </a>
                  </div>
                  {order.customerPhone && (
                    <div className="customer-detail-row">
                      ...
                      <a href={`tel:${order.customerPhone}`} className="customer-value customer-link">
                        {order.customerPhone}
                      </a>
                    </div>
                  )}
