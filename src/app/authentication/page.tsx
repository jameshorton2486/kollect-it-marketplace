    ...
    <div>
      ...
      <section className="section-spacing section-alt text-center">
        <div className="container max-w-[900px]">
          ...
          <p className="max-w-[700px] mx-auto text-base leading-7 text-ink-secondary" data-reveal data-reveal-delay="200">
        ...
        <div className="container max-w-[900px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="split-fade-left">
              <div className="w-[50px] h-[50px] rounded-full bg-surface-1 flex items-center justify-center mb-4 text-gold text-2xl">✓</div>
