...
export const metadata: Metadata = {
  ...
  description:
    "Browse our curated collections of fine art, antique books, collectibles, and militaria.",
};
    ...
    <div>
      ...
      <header className="header">
        <div className="header-container">
          ...
          <div className="header-icons">{/* Icons placeholder */}</div>
        </div>
      ...
      <section className="shop-page">
        <div className="container">
          ...
          <div className="shop-intro text-center mb-[clamp(3rem,6vw,5rem)]">
            ...
            <p
              className="max-w-[700px] mx-auto text-base leading-[1.7] text-ink-secondary"
              data-reveal
              data-reveal-delay="200"
            >
              Discover authenticated art pieces, rare books, collectibles, and
              historical artifacts curated for discerning collectors who insist
          ...
          <div className="category-grid-new">
            {categories.map((category) => (
              <Link
                ...
                className="category-card shop-category-tile"
              >
