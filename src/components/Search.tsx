...
export default function Search() {
  ...
  return (
    <div className="relative" ref={boxRef}>
      ...
      >
        <div
          className={`flex wfull items-center gap-2 rounded border px-3 py-2 bg-white focus-within:border-[#B1874C] focus-within:ring-1 focus-within:ring-[#B1874C]`}
        >
          {/* Magnifying glass */}
          <svg
            width="18"
      ...
      {open && (
        <div
          id="search-dropdown"
          className="absolute z-50 mt-2 w-[420px] max-w-[90vw] rounded border border-border-neutral bg-white p-2 shadow-md"
