...
export default function ProductTabs({ product }: ProductTabsProps) {
  const [activeTab, setActiveTab] = useState<
    "details" | "shipping" | "authentication"
  >("details");
        ...
        <div className="product-tabs-content leading-[1.8] text-ink-muted">
          ...
          {activeTab === "shipping" && (
            <div className="tab-panel">
              ...
              <p>
                We offer complimentary white-glove shipping on all orders over
                $99 within the continental United States. International shipping
              ...
              <ul>
                ...
                <li>
                  <strong>International:</strong> 10-14 business days
                </li>
              </ul>
              ...
              <p>
                ...
                Items must be returned in their original condition. Please
                contact our concierge team to initiate a return.
              </p>

              <h4 className="font-serif text-brand-navy">Packaging</h4>
              <p>
                All items are professionally packaged with museum-quality
                materials to ensure safe transit. Fragile items receive
                additional protective packaging and insurance.
              </p>
            </div>
          )}
          ...
          {activeTab === "authentication" && (
            <div className="tab-panel">
              ...
              <ul>
                <li>
                  <strong>Expert Examination:</strong> Physical inspection by
                  category specialists
                </li>
                <li>
                  <strong>Provenance Research:</strong> Verification of item
                  history and ownership
                </li>
                <li>
                  <strong>Condition Assessment:</strong> Detailed evaluation and
                  documentation
                </li>
                <li>
                  <strong>Market Analysis:</strong> Fair pricing based on
              ...
              <p>
                Select items include a Certificate of Authenticity from
                Kollect-It or the original artist/maker. All documentation is
                carefully preserved and included with your purchase.
              </p>

              <h4 className="font-serif text-brand-navy">Lifetime Guarantee</h4>
              <p>
                If any item is ever determined to be inauthentic, we will
                provide a full refund including original shipping costs. This
                guarantee remains valid for the lifetime of the item.
              </p>
            </div>
          )}
        </div>
