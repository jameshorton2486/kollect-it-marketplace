...
export function Button({
  ...
  const variantStyles: Record<NonNullable<ButtonProps["variant"]>, string> = {
    primary:
      "bg-cta text-white hover:bg-cta-hover shadow-md hover:shadow-lg focus-visible:ring-cta",
    secondary:
      "bg-surface-1 text-ink hover:bg-surface-2 border border-border-neutral hover:border-ink focus-visible:ring-ink",
    accent:
      "bg-gold text-ink-inverted hover:bg-gold-hover shadow-md hover:shadow-lg focus-visible:ring-gold",
  };
